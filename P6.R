...
menores_si <- menores %>% filter(P6 == "Sí")
menores_no <- menores %>% filter(P6 == "No")

mayores_si <- mayores %>% filter(P6 == "Sí")
mayores_no <- mayores %>% filter(P6 == "No")
...
crear_nube(menores_si$R6)
crear_nube(menores_no$R6)

#Nubes para "mayores"

crear_nube(mayores_si$R6)
crear_nube(mayores_no$R6)
