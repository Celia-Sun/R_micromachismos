...
menores_si <- menores %>% filter(P3 == "Sí")
menores_no <- menores %>% filter(P3 == "No")

mayores_si <- mayores %>% filter(P3 == "Sí")
mayores_no <- mayores %>% filter(P3 == "No")
...
crear_nube(menores_si$R3)
crear_nube(menores_no$R3)

#Nubes para "mayores"

crear_nube(mayores_si$R3)
crear_nube(mayores_no$R3)
