...
menores_si <- menores %>% filter(P5 == "Sí")
menores_no <- menores %>% filter(P5 == "No")

mayores_si <- mayores %>% filter(P5 == "Sí")
mayores_no <- mayores %>% filter(P5 == "No")
...
crear_nube(menores_si$R5)
crear_nube(menores_no$R5)

#Nubes para "mayores"

crear_nube(mayores_si$R5)
crear_nube(mayores_no$R5)
