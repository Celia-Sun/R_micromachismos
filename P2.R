...
menores_si <- menores %>% filter(P2 == "Sí")
menores_no <- menores %>% filter(P2 == "No")

mayores_si <- mayores %>% filter(P2 == "Sí")
mayores_no <- mayores %>% filter(P2 == "No")
...
crear_nube(menores_si$R2)
crear_nube(menores_no$R2)

#Nubes para "mayores"

crear_nube(mayores_si$R2)
crear_nube(mayores_no$R2)
