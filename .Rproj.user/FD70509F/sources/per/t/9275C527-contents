...
menores_si <- menores %>% filter(P4 == "Sí")
menores_no <- menores %>% filter(P4 == "No")

mayores_si <- mayores %>% filter(P4 == "Sí")
mayores_no <- mayores %>% filter(P4 == "No")
...
crear_nube(menores_si$R4)
crear_nube(menores_no$R4)

#Nubes para "mayores"

crear_nube(mayores_si$R4)
crear_nube(mayores_no$R4)
